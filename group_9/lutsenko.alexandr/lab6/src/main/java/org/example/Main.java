...
public class Main {
    ...
    private static final String PHILOSOPHER_NAME_2 = "Ницше";
    private static final String PHILOSOPHER_NAME_3 = "Кант";
    private static final String PHILOSOPHER_NAME_4 = "Сократ";
    private static final String PHILOSOPHER_NAME_5 = "Платон";
