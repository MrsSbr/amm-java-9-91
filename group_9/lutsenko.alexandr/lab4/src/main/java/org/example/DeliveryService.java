...
public class DeliveryService {
    ...
    public static void main(String[] args) {
        String ordersFilePath = "group_9/lutsenko.alexandr/lab4/src/resource/orders.txt";
        String outputFilePath = "group_9/lutsenko.alexandr/lab4/src/resource/output.txt";
        ...
        String result = "Courier with most restaurants: " + findCourierWithMostRestaurants(orders) + "\n" +
                "Restaurant with most dishes last year: " + findRestaurantWithMostDishesLastYear(orders) + "\n" +
