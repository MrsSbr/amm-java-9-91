...
public class StudentFactory {
    ...
    static {
        MAN_NAMES = Collections.unmodifiableList(List.of("Иван", "Петр", "Александр", "Владимир", "Глеб", "Борис", "Даниил", "Клим", "Антон"));
        WOMAN_NAMES =  Collections.unmodifiableList(List.of("Дарья", "Софья", "Ольга", "Маргарита", "Надежда", "Кристина", "Светлана", "Анна", "Ирина"));
        SURNAMES = Collections.unmodifiableList(List.of("Петров", "Иванов", "Сидоров", "Алексеев", "Кравцов", "Медведев", "Захаров", "Назаров", "Михайлов"));
    }
    public static Student generateStudent() {
        ...
        return new StudentBuilder()
                ...
                .withNumberRecordBook(rand.nextInt(89999999)+10000000).build();
    }
}
