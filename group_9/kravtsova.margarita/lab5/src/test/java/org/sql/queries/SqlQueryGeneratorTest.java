...
class SqlQueryGeneratorTest {
    ...
    void generateSelectAllEntitiesQuery() {
        String expectedResult = "SELECT idCat, name, gender, age, breed, fertility, hasMaster\nFROM Cats;";
    ...
    @Test
    void generateInsertQueriesWithInjection() {
        Cat badCat = new Cat(50, "aboba');DROP TABLE Cats;", Gender.MALE,
                2, CatBreeds.BENGALI, false, true);
        String expectedResult = "INSERT INTO Cats (name, gender, age, breed, fertility, hasMaster)\n" +
                "VALUES ('aboba'');DROP TABLE Cats;', MALE, 2, BENGALI, false, true);";
        assertEquals(expectedResult, generator.generateInsertQueries(badCat));
    }
}