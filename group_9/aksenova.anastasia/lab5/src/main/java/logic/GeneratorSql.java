...
public class GeneratorSql {
    ...
    public static String generateSampleQuery(Class<?> object) {
        // Генерация примера SELECT-запроса
        return "SELECT " + getFieldsName(object) + " FROM " + getTableName(object) + " LIMIT 10";
    }
}
