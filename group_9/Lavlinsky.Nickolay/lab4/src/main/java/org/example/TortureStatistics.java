...
public class TortureStatistics {
    ...
    public Map<TortureTool, Long> countResitsByTool(List<StudentRecord> records) {
    ...
    public Map<String, Integer> calculateTotalTortureTime(List<StudentRecord> records) {
        return records.stream()
    ...
    public List<String> studentsTorturedByAllToolsAndPassed(List<StudentRecord> records) {
