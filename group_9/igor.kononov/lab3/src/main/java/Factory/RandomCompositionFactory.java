...
public class RandomCompositionFactory {
    private static long START_EPOCH = LocalDate.of(1970, 1, 1).toEpochDay();
    private static long END_EPOCH = LocalDate.of(2023, 12, 31).toEpochDay();

    private static final List<Object> LIST_OF_NAMES;
    ...
    static {
        LIST_OF_NAMES = List.of(
                ...
                new Pair<>("Bohemian Rhapsody", "Queen"),
                new Pair<>("Hotel California", "Eagles"),
                new Pair<>("Bohemian Rhapsody", "Queen"),
                new Pair<>("Hotel California", "Eagles"),
                new Pair<>("Bohemian Rhapsody", "Queen"),
    ...
    private long randomDay = START_EPOCH + random.nextInt((int)(END_EPOCH - START_EPOCH));
